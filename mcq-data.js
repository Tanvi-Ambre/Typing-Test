...
// Generated: 2026-03-29T19:47:58.213Z
// Total batches: 29
// Total questions: 724
...
const allMCQBatches = {
  ...
  "BATCH 1103": [
    ...
    {
      "id": 12,
      "question": "increase Font धल button चधल\nखललध … … … … … .. म ध button\nआम.ध",
      "options": {
        "A": "Decrease\nFont",
        "B": "Font Size",
        "C": "Increase Font",
    ...
    {
      "id": 18,
      "question": "Notes page view कहणतधल\ntab मधघन वलपरतल धधतह?",
      "options": {
        "A": "Insert",
        "B": "File",
        "C": "Edit",
    ...
    {
      "id": 21,
      "question": "आपण backward arrow\nवलपरलधलननतर, पकढधल webpage\nवर जलणधलसलठध ____________\nवलपर कर शकतह.",
      "options": {
        "A": "Forward\nArrow",
        "B": "Backward\nArrow",
        "C": "Down Arrow",
    ...
    {
      "id": 22,
      "question": "आपलधललल एखलदल E-Mail लल\nउतर दणध धलसलठध\n_______________ बननवर\nणकलक करलवध ललगत.ध",
      "options": {
        "A": "Forward",
        "B": "Compose",
        "C": "Delete",
    ...
    {
      "id": 23,
      "question": "Gmail चधल कहणतधलमध\nsettings बदलणधलकरधतल\n________________ बनन वर\nclick करलव.ध",
      "options": {
        "A": "Spam",
        "B": "Settings",
        "C": "Trash",
    ...
    {
      "id": 24,
      "question": "इननरनधनवदलरध एखलदध फलईल एकल\nकफममधकनर वरन दसक ऱधल\nकफममधकनरवर पलठणवलध जलतध तधवमल\nखललधल पपकक कहणतध सनजल\nवलपरलध जलईल.",
      "options": {
        "A": "Usenet",
        "B": "Telnet",
        "C": "FTP",
  ...
  "BATCH 1104": [
    ...
    {
      "id": 7,
      "question": "MS-Word मधहल ___नध आपण\nruler ररहल option show\nककरय Hide कधलध जयतयत",
      "options": {
        "A": "Insert",
        "B": "Home",
        "C": "Help",
  ...
  "BATCH 1201": [
    ...
    {
      "id": 15,
      "question": "Workbook मधठल sheet चध\nनचव बदलतच यधत.ध",
      "options": {
        "A": "बरयबर",
        "B": "चबक",
        "C": "",
  ...
  "BATCH 1202": [
    ...
    {
      "id": 5,
      "question": "जगभरततचल biggest network\nककणतध ?",
      "options": {
        "A": "LAN",
        "B": "MAN",
        "C": "Internet",
  ...
  "BATCH 1203": [
    ...
    {
      "id": 4,
      "question": "Computer चतत --------- मधमरच\nमधचल मतहहतच फक वतचतत तधतध\nतततत बदल करतत तधत नतहच.",
      "options": {
        "A": "ROM",
        "B": "RAM",
        "C": "DRAM",
    ...
    {
      "id": 6,
      "question": "एमएस वडर मधत,ध footnotes,\nendnotes & indexes ह धसवर\n____ इनसटर कर शकतक",
      "options": {
        "A": "Hyperlinks",
        "B": "Booksmarks",
        "C": "Word fields",
    ...
    {
      "id": 12,
      "question": "… … … bar चतत उजवत side\nलत Zoom slider strip बघतत\nतधत.ध",
      "options": {
        "A": "Scroll bar",
        "B": "Title Bar",
        "C": "Status Bar",
    ...
    {
      "id": 23,
      "question": "पहहलतत हपढचमधचल\nComputers\nमधत_ध ______________\nवतपरलध हकत.ध",
      "options": {
        "A": "Transistors",
        "B": "Vacuum\nTubes",
        "C": "Integrated\nCircuits",
  ...
  "BATCH 1405": [
    {
      "id": 1,
      "question": "Metallic platters चा वचपर\n__________ मध्येध कधला जातोत.",
      "options": {
        "A": "Hard Disk",
        "B": "Floppy Disk",
        "C": "CD",
  ...
  "BATCH 1603": [
    ...
    {
      "id": 14,
      "question": "MS Excel 2019 मधचस Fill\ncolor पचचरच कबठस उपलबध असतब\n?",
      "options": {
        "A": "home tab",
        "B": "data tab",
        "C": "Insert tab",
    ...
    {
      "id": 19,
      "question": "मचगहल slide ला जचणचचसचठह\n_______ key press करचवह.",
      "options": {
        "A": "Slide No +\nEnter",
        "B": "Pg. Up",
        "C": "Home",
