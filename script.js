...
// Sample passages for 30 WPM test (approximately 210 words for 7 minutes)
// Each paragraph starts with 5 spaces for proper indentation (standard typing format)
const passages = [
    "     The art of communication is the language of leadership. Effective leaders know that their words have power and impact. They choose their words carefully and speak with clarity and purpose. Good communication builds trust and creates strong relationships. It helps teams work together towards common goals. When people understand each other well, they can solve problems more easily.\n     Clear communication reduces confusion and prevents mistakes. It saves time and improves productivity. In the workplace, good communication skills are essential for success. They help in presenting ideas, giving feedback, and resolving conflicts. Active listening is just as important as speaking clearly. When we listen carefully to others, we show respect and build rapport.\n     Communication is not just about words. Body language, tone of voice, and facial expressions also convey important messages. Being aware of these non-verbal cues helps us communicate more effectively. In today's digital age, written communication has become increasingly important. Taking time to improve communication skills is a worthwhile investment. Practice makes perfect, and anyone can become a better communicator with effort and dedication.",
    
    "     Technology has transformed the way we live and work. From smartphones to artificial intelligence, innovations continue to shape our daily lives. The internet has connected people across the globe, making information accessible to everyone. Social media platforms allow us to share experiences and stay in touch with friends and family. Online shopping has revolutionized retail, offering convenience and variety.\n     Digital payment systems have made transactions faster and more secure. Cloud computing enables businesses to store and access data from anywhere. Remote work has become common, giving employees flexibility and balance. Video conferencing tools help teams collaborate effectively across distances. Educational technology has opened new learning opportunities for students worldwide. Learning platforms provide courses on countless subjects, making education more accessible.\n     Healthcare has benefited from technological advances with telemedicine and electronic health records. Wearable devices track fitness and health metrics, encouraging healthier lifestyles. However, with these benefits come challenges. Privacy concerns and cybersecurity threats require constant attention. As technology evolves, we must adapt and learn continuously. The future promises even more exciting innovations that will further change our world.",
    
    "     Education is the foundation of personal and societal growth. It empowers individuals with knowledge and skills needed to succeed in life. Learning begins in childhood and continues throughout our lives. Schools provide structured environments where students acquire fundamental abilities in reading, writing, and mathematics. Teachers play a crucial role in shaping young minds and inspiring curiosity. They guide students through challenges and celebrate their achievements.\n\n     Education extends beyond academic subjects to include critical thinking and problem solving. It teaches us how to analyze information and make informed decisions. Social skills developed in educational settings help us interact effectively with others. Teamwork and collaboration are essential skills learned through group projects and activities. Education opens doors to career opportunities and economic advancement.\n\n     Access to quality education should be a right for everyone, regardless of background or circumstances. Libraries and educational resources make learning accessible to all. Online courses and digital tools have expanded educational opportunities globally. Lifelong learning keeps our minds active and helps us adapt to changing world. Investing in education creates a brighter future for generations to come.",
    
    "     Health and wellness are essential components of a fulfilling life. Taking care of our physical and mental wellbeing requires conscious effort and dedication. Regular exercise strengthens our bodies and improves cardiovascular health. It boosts energy levels and enhances mood through the release of endorphins. A balanced diet provides the nutrients our bodies need to function optimally. Fresh fruits and vegetables supply vitamins and minerals that support immune system.\n\n     Adequate sleep is crucial for physical recovery and mental clarity. Most adults need seven to nine hours of quality sleep each night. Stress management techniques help us cope with daily challenges and pressures. Meditation and deep breathing exercises promote relaxation and reduce anxiety. Staying hydrated by drinking plenty of water supports all bodily functions. Regular health checkups and preventive care catch potential issues early.\n\n     Mental health is just as important as physical health and deserves attention. Talking to friends, family, or professionals helps us process emotions and experiences. Building strong social connections contributes to overall happiness and longevity. Avoiding harmful habits like smoking and excessive alcohol consumption protects our health. Small positive changes in daily routines can lead to significant improvements over time.",
    
    "     Environmental conservation is one of the most pressing challenges of our time. Climate change affects weather patterns and threatens ecosystems worldwide. Rising temperatures cause glaciers to melt and sea levels to rise. Extreme weather events like hurricanes and droughts are becoming more frequent and severe. Deforestation destroys habitats and reduces biodiversity on our planet.\n\n     Pollution contaminates air, water, and soil, harming both wildlife and human health. Plastic waste accumulates in oceans, endangering marine life and ecosystems. Sustainable practices help reduce our environmental footprint and preserve natural resources. Recycling and composting minimize waste sent to landfills. Renewable energy sources like solar and wind power offer clean alternatives to fossil fuels. Energy efficient appliances and vehicles reduce consumption and emissions.\n\n     Conservation efforts protect endangered species and their habitats. Planting trees helps absorb carbon dioxide and produces oxygen we breathe. Individual actions collectively make a significant difference in environmental protection. Choosing reusable products over single use items reduces waste generation. Supporting environmentally responsible companies encourages sustainable business practices. Working together, we can create a healthier and more sustainable world for future generations.",
    
    "     Time management is a valuable skill that improves productivity and reduces stress. Planning your day helps you prioritize important tasks and meet deadlines effectively. Making a to-do list keeps you organized and focused on what needs to be done. Breaking large projects into smaller steps makes them more manageable and less overwhelming.\n\n     Setting realistic goals gives you direction and motivation to achieve success. Avoiding procrastination saves time and prevents last-minute rushes. Learning to say no to unnecessary commitments protects your time and energy. Taking regular breaks actually improves concentration and prevents burnout. Using tools like calendars and reminders helps you stay on track with your schedule.\n\n     Eliminating distractions creates a better environment for focused work. Delegating tasks when possible allows you to concentrate on high-priority activities. Reviewing your progress regularly helps you adjust your plans and improve efficiency. Good time management creates more opportunities for personal growth and leisure activities. Mastering this skill leads to greater achievement and a more balanced life.",
    
    "     Reading is a gateway to knowledge and imagination. Books transport us to different worlds and introduce us to diverse perspectives. Through reading, we expand our vocabulary and improve our language skills. It enhances our ability to think critically and analyze complex ideas. Regular reading strengthens concentration and improves memory retention.\n\n     Fiction allows us to experience emotions and situations beyond our daily lives. It develops empathy by helping us understand characters from various backgrounds. Non-fiction provides factual information and insights into real-world topics. Biographies inspire us with stories of remarkable people and their achievements. Reading news and articles keeps us informed about current events and global issues.\n\n     Establishing a daily reading habit enriches our lives in countless ways. Libraries offer free access to millions of books and resources. Digital platforms make reading more convenient with e-books and audiobooks. Joining book clubs creates opportunities for discussion and social connection. Whether for education or entertainment, reading remains one of the most rewarding activities we can pursue."
];
